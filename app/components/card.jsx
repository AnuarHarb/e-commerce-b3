  ...
  return (
    <StyledCard>
      ...
      <div className={`card-descipcion-container ${enCarrito ? 'activo' : ''}`}>
        <h2 className="titulo">{titulo} - {precio}</h2>
        ...
        {mostrarDescripcion ? (
          ...
          <div>
            ...
            <button onClick={() => setmostrarDescripcion(true)}>Ver descripción completa</button>
          </div>
        )}
        ...
        <div className="card-checkout-buttons">
          ...
          <button onClick={() => setEnCarrito(true)}>Añadir al carrito</button>
        </div>
      </div>
